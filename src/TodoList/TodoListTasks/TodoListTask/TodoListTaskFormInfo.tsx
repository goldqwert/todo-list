...
class TodoListTaskFormInfo extends React.Component<IProps> {
    render = () => {
        ...
        return (<div className={s.borderForWord}>
            <div className={s.taskButtons}><a onClick={this.props.deleteTask}>
                <div className={s.borderForSVG}><svg height="15px" viewBox="0 0 512 512" width="15px" fill='#c30202' xmlns="http://www.w3.org/2000/svg">
