                ...
                <div className={classForTasks}>
                    {this.state.editMode
                        ...
                        : <div className={s.borderForWord}>
                            <div className={s.taskButtons}><a onClick={this.deleteTask}>
                                <div className={s.borderForSVG}><svg height="15px" viewBox="0 0 512 512" width="15px" fill='red' xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a onClick={this.activateEditMode}>
                                    <div className={s.borderForSVG}><svg height="15px" viewBox="0 -1 401.52289 401" width="15px" fill='blue' xmlns="http://www.w3.org/2000/svg">
                            ...
                            <p>Done: <input onChange={this.onChangeStatus} type='checkbox' checked={this.props.task.status}
